  ...
  return (
    <div>
      ...
      {loading && (
        ...
        <div style={{ background: 'linear-gradient(135deg, #667eea 0%, #764ba2 100%)', borderRadius: '16px', padding: '1.25rem', textAlign: 'center', color: 'white' }}>
        ...
        <div style={{ background: 'linear-gradient(135deg, #10b981 0%, #059669 100%)', borderRadius: '16px', padding: '1.25rem', textAlign: 'center', color: 'white' }}>
        ...
        <div style={{ background: 'linear-gradient(135deg, #f59e0b 0%, #d97706 100%)', borderRadius: '16px', padding: '1.25rem', textAlign: 'center', color: 'white' }}>
