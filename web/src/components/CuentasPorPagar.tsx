    ...
    <div>
      ...
      <div style={{
        ...
        <div style={{ background: 'var(--color-surface)', border: '1px solid var(--color-border)', borderRadius: '12px', padding: '1rem', textAlign: 'center' }}>
          <p style={{ margin: 0, color: 'var(--color-text-muted)', fontSize: '0.875rem', fontWeight: 600 }}>Pendientes</p>
          <p style={{ margin: '0.25rem 0 0 0', fontSize: '1.5rem', fontWeight: 700, color: '#dc2626' }}>
            {stats.pendientes}
          </p>
        </div>
        <div style={{ background: 'var(--color-surface)', border: '1px solid var(--color-border)', borderRadius: '12px', padding: '1rem', textAlign: 'center' }}>
          <p style={{ margin: 0, color: 'var(--color-text-muted)', fontSize: '0.875rem', fontWeight: 600 }}>Parciales</p>
          <p style={{ margin: '0.25rem 0 0 0', fontSize: '1.5rem', fontWeight: 700, color: '#ea580c' }}>
            {stats.parciales}
          </p>
        </div>
        <div style={{ background: 'var(--color-surface)', border: '1px solid var(--color-border)', borderRadius: '12px', padding: '1rem', textAlign: 'center' }}>
          <p style={{ margin: 0, color: 'var(--color-text-muted)', fontSize: '0.875rem', fontWeight: 600 }}>Pagadas</p>
