...
const MOCK_PRODUCTOS_VENDIDOS: ProductoVenta[] = [
  ...
  { id: '2', nombre: 'Medellin 375 (3 años)', codigo: 'MED375', cantidad: 10, total: 280000, ganancia: 100000, timestamp: new Date().toISOString() },
  ...
  { id: '4', nombre: 'Medellin 750 (8 años)', codigo: 'MED750', cantidad: 5, total: 525000, ganancia: 200000, timestamp: new Date().toISOString() },
...
const MOCK_EMPLEADOS_VENTAS: EmpleadoVenta[] = [
  {
    ...
    detalles: [
      ...
      { id: '1-2', nombre: 'Medellin 375 (3 años)', codigo: 'MED375', cantidad: 4, total: 112000, ganancia: 40000, timestamp: '' },
    ]
  },
  {
    id: '2',
  ...
  },
  {
    ...
    detalles: [
      { id: '3-1', nombre: 'Medellin 750 (8 años)', codigo: 'MED750', cantidad: 3, total: 315000, ganancia: 120000, timestamp: '' },
    ]
  },
];

const MOCK_DESPACHOS: DespachoItem[] = [
  { id: '1', producto: 'Medellin 375 (5 años)', cantidad: 7, estado: 'enviado', cliente: 'Bodega Principal', fecha: '2026-03-23', vendedor: 'Admin' },
