...
import { Package, ClipboardList, TrendingUp, History, FileText, CreditCard, Users, Landmark, ShoppingCart, BarChart2, LayoutDashboard, LogOut, Building2, Activity, ArrowLeftRight, AlertCircle, Lock } from 'lucide-react';
...
export default function App() {
  ...
  const allNavItems = [
    ...
    { id: 'movimientos' as Page, label: 'Movimientos de Caja', icon: <ArrowLeftRight size={18} />, desc: 'Ingresos y egresos' },
